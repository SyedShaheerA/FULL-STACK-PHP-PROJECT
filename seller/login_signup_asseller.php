...
<body>
  ...
  <div class="container-fluid  text-primary">
    <a class="navbar-brand"  style="color:white;" href="#">BOOKS FOR SALE</a>
    ...
    <div class="collapse navbar-collapse  my-2 my-lg-0 " id="navbarNavDropdown">
      <ul class="navbar-nav ms-auto" >
        ...
        <li class="nav-item">
          <a class="nav-link "   style="color:white;"href="/PROJECT/seller/insertbook.php">Upload Book</a>
        </li>
        <li class="nav-item">
          <a class="nav-link "   style="color:white;"href="REGISTERATION/login_signup_asseller.php">Account</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div  STYLE=" margin-top: 20px; justify-content: center; align-items: center;display: flex;  font-family: fantasy; font-size:large;">
            ...
            <div style="margin-top: 150px;"> 
              ...
              <div style= "justify-content: center; align-items: center;display: flex; color: BLUE">
                <input type="text" name="seller_id" id="seller_id" placeholder="ID"><br>
              </div>
              <div style= "justify-content: center; align-items: center;display: flex; color: BLUE">
              ...
              <div  style="margin-top:150px; justify-content: center; align-items: center;display: flex; color: rgb(128, 0, 255); background-color: rgba(255,255,255,0.5) ;">
                <a href="registerasseller.html"> REGISTER </a> 
              </div>
...
function loadProfile()
  {
      ...
      if (this.readyState == 4 && this.status == 200) {
        document.getElementById("check").innerHTML=this.responseText;
          ...
          if (response != "connectedpass") {
            document.getElementById("check").innerHTML =response//"INCORRECT USERNAME OR PASSWORD";
            // this.responseText;
            //;
          } 
          else {
    ...
    xhttp.open("POST", "sellerlogin.php?seller_id="+document.getElementById("seller_id").value+"&password="+document.getElementById("PASS").value, true);
    xhttp.send();
  }
</script>
